...
{
   xRot += 1/M_PI*(GLfloat)(pe->y()-ptrMousePosition.y());//height();
...
void letter::getVertexArray(float k){
    ...
    VertexArray[4][0]=0;
    VertexArray[4][1]=0.25*k;
    VertexArray[4][2]=0;

    VertexArray[5][0]=0.25*k;
    VertexArray[5][1]=0.25*k;
    VertexArray[5][2]=0;

    VertexArray[6][0]=0.25*k;
    VertexArray[6][1]=0.25*k;
    VertexArray[6][2]=-0.25*k;

    VertexArray[7][0]=0;
    VertexArray[7][1]=0.25*k;
    ...
    VertexArray[10][1]=1*k;
    VertexArray[10][2]=-0.25*k;

    VertexArray[11][0]=0;
    VertexArray[11][1]=1*k;
    VertexArray[11][2]=-0.25*k;

    VertexArray[12][0]=0;
    VertexArray[12][1]=1.25*k;
    VertexArray[12][2]=0;

    VertexArray[13][0]=0.25*k;
    VertexArray[13][1]=1.25*k;
    VertexArray[13][2]=0;

    VertexArray[14][0]=0.25*k;
    VertexArray[14][1]=1.25*k;
    VertexArray[14][2]=-0.25*k;

    VertexArray[15][0]=0;
    VertexArray[15][1]=1.25*k;
    ...
    VertexArray[20][0]=0;
    VertexArray[20][1]=2.25*k;
    VertexArray[20][2]=0;

    VertexArray[21][0]=0.25*k;
    VertexArray[21][1]=2.25*k;
    VertexArray[21][2]=0;

    VertexArray[22][0]=0;
    VertexArray[22][1]=2.25*k;
    VertexArray[22][2]=-0.25*k;

    VertexArray[23][0]=0.25*k;
    VertexArray[23][1]=2.25*k;
    VertexArray[23][2]=-0.25*k;

    VertexArray[24][0]=0.75*k;
    VertexArray[24][1]=0*k;
    VertexArray[24][2]=0;

    VertexArray[25][0]=1*k;
    VertexArray[25][1]=0*k;
    VertexArray[25][2]=0*k;

    VertexArray[26][0]=k;
    VertexArray[26][1]=0*k;
    VertexArray[26][2]=-0.25*k;

    VertexArray[27][0]=0.75*k;
    VertexArray[27][1]=0;
    VertexArray[27][2]=-0.25*k;

    VertexArray[28][0]=0.75*k;
    VertexArray[28][1]=0.25*k;
    VertexArray[28][2]=0;

    VertexArray[29][0]=1*k;
    VertexArray[29][1]=0.25*k;
    VertexArray[29][2]=0*k;

    VertexArray[30][0]=1*k;
    VertexArray[30][1]=0.25*k;
    VertexArray[30][2]=-0.25*k;

    VertexArray[31][0]=0.75*k;
    VertexArray[31][1]=0.25*k;
    VertexArray[31][2]=-0.25*k;

    VertexArray[32][0]=0.75*k;
    VertexArray[32][1]=k;
    VertexArray[32][2]=0;

    VertexArray[33][0]=1*k;
    VertexArray[33][1]=k;
    VertexArray[33][2]=0;
    ...
    VertexArray[35][0]=0.75*k;
    VertexArray[35][1]=k;
    VertexArray[35][2]=-0.25*k;

    VertexArray[36][0]=0.75*k;
    VertexArray[36][1]=1.25*k;
    VertexArray[36][2]=0;

    VertexArray[37][0]=1*k;
    VertexArray[37][1]=1.25*k;
    VertexArray[37][2]=0;

    VertexArray[38][0]=1*k;
    VertexArray[38][1]=1.25*k;
    VertexArray[38][2]=-0.25*k;

    VertexArray[39][0]=0.75*k;
    VertexArray[39][1]=1.25*k;
    VertexArray[39][2]=-0.25*k;

    VertexArray[40][0]=0.75*k;
    ...
    VertexArray[42][0]=k;
    VertexArray[42][1]=2*k;
    VertexArray[42][2]=-0.25*k;

    VertexArray[43][0]=0.75*k;
    VertexArray[43][1]=2*k;
    VertexArray[43][2]=-0.25*k;

    VertexArray[44][0]=0.75*k;
    VertexArray[44][1]=2.25*k;
    VertexArray[44][2]=0;

    VertexArray[45][0]=k;
    VertexArray[45][1]=2.25*k;
    VertexArray[45][2]=0;

    VertexArray[46][0]=k;
    VertexArray[46][1]=2.25*k;
    VertexArray[46][2]=-0.25*k;

    VertexArray[47][0]=0.75*k;
    VertexArray[47][1]=2.25*k;
...
void letter::draw_rotation_z()
{
    ...
    glDrawElements(GL_QUADS, 102, GL_UNSIGNED_BYTE, IndexArray);
...
void letter::draw_rotation_x()
{
    ...
    glVertexPointer(3, GL_FLOAT, 0, c);
    glDrawElements(GL_QUADS, 84, GL_UNSIGNED_BYTE, IndexArray);
